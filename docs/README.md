...
|---|---|---|---|
| 2026-09-23 | [Architecture deepening program](design/2026-09-23-architecture-deepening.md) | Reviewed | Eight deepening candidates from the 2026-09-23 review: engine admission/replay, run outcomes, store ownership, verify path, framework vocabulary, failure kinds, jobs lifecycle, explain — with decisions, rationale, staged plans and acceptance tests. |
